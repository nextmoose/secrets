...
in {
	...
	atom-project = tools.atom-project ( tools.local-directory "3f78d11f-ea32-4a6f-b656-c1a7cb933fb3" ) ( tools.local-directory "fcb9f65e-7efe-4a79-bd98-19d681510f56" ) ( tools.fetch-git "${ dot-ssh }/config" "Emory Merryman" "emory.merryman@gmail.com" "upstream:rebelplutonium/nix.git" "master" "personal:nextmoose/nix.git" "report:rebelplutonium/nix.git" ) ;
	emacs-project = tools.emacs-project ( tools.local-directory "8bfb8e2d-f7c0-492f-8e43-f59dea62d625" ) ( tools.fetch-git "${ dot-ssh }/config" "Emory Merryman" "emory.merryman@gmail.com" "upstream:rebelplutonium/nix.git" "master" "personal:nextmoose/nix.git" "report:rebelplutonium/nix.git" ) ;
	brackets-project = tools.brackets-project ( tools.local-directory "8bfb8e2d-f7c0-492f-8e43-f59dea62d625" ) ( tools.fetch-git "${ dot-ssh }/config" "Emory Merryman" "emory.merryman@gmail.com" "upstream:rebelplutonium/nix.git" "master" "personal:nextmoose/nix.git" "report:rebelplutonium/nix.git" ) ;
	sublime-project = tools.sublime-project ( tools.local-directory "8bfb8e2d-f7c0-492f-8e43-f59dea62d625" ) ( tools.fetch-git "${ dot-ssh }/config" "Emory Merryman" "emory.merryman@gmail.com" "upstream:rebelplutonium/nix.git" "master" "personal:nextmoose/nix.git" "report:rebelplutonium/nix.git" ) ;
    } ;
    sources = [
        ( tools.pass-completion "boot-secrets" ( tools.dot-gnupg ( boot-secret-file "gpg-private-keys" ) ( boot-secret-file "gpg-ownertrust" ) ( boot-secret-file "gpg2-private-keys" ) ( boot-secret-file "gpg2-ownertrust" ) ) ( tools.fetch-git "${ dot-ssh }/config" "Emory Merryman" "emory.merryman@gmail.com" "upstream:nextmoose/secrets.git" "df8400df-08c0-4998-ac86-6ee210076eab" "personal:nextmoose/secrets.git" "report:nextmoose/secrets.git" ) )
    ] ;
    variables = {
